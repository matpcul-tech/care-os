...
import {
  Heart, Shield, Calendar, Bell, Users, MessageCircle, FileText,
  Pill, ChevronRight, Star, ArrowRight, Check, Smartphone, Zap,
  Clock, Phone, AlertTriangle, Bot
} from 'lucide-react'
  ...
  return (
    <div style={{ background: '#FAF8F5', minHeight: '100vh' }}>
      <style>{`
        ...
        .lp-logo-mark {
          width: 32px; height: 32px; background: #E07A5F; border-radius: 50%;
          display: flex; align-items: center; justify-content: center;
        }
        .lp-nav-links { display: flex; gap: 32px; align-items: center; }
        .lp-nav-link {
          font-size: 14px; font-weight: 500; color: #7A7570;
        ...
        .lp-hero::before {
          ...
          background:
            radial-gradient(ellipse 600px 400px at 20% 30%, rgba(224,122,95,0.08), transparent),
            radial-gradient(ellipse 500px 500px at 80% 70%, rgba(129,178,154,0.07), transparent),
            radial-gradient(ellipse 400px 300px at 50% 50%, rgba(91,143,168,0.05), transparent);
        }
        .lp-badge {
          display: inline-flex; align-items: center; gap: 8px;
          padding: 8px 18px; border-radius: 24px;
          background: white; border: 1px solid #EDE8E3;
          font-size: 13px; font-weight: 500; color: #7A7570;
          margin-bottom: 28px; position: relative;
          box-shadow: 0 2px 8px rgba(44,42,40,0.04);
        }
        .lp-badge-dot {
          width: 8px; height: 8px; border-radius: 50%; background: #81B29A;
        ...
        .lp-h1 {
          ...
          letter-spacing: -1.5px; max-width: 800px;
        ...
        .lp-avatar-circle {
          ...
          border: 2.5px solid #FAF8F5; margin-left: -8px;
        }
        ...
        .lp-section-label {
          ...
          text-transform: uppercase; color: #E07A5F; margin-bottom: 12px;
        }
        .lp-section-title {
          font-family: 'Fraunces', Georgia, serif;
        ...
        .lp-section-subtitle {
          ...
          color: #7A7570; max-width: 560px; margin-bottom: 48px;
        }
        ...
        .lp-problem-card {
          ...
          border: 1px solid #EDE8E3; background: white;
          transition: all 0.2s;
        }
        .lp-problem-card:hover { box-shadow: 0 8px 24px rgba(44,42,40,0.06); }
        .lp-problem-emoji { font-size: 28px; margin-bottom: 14px; }
        .lp-problem-title {
          font-weight: 600; font-size: 15px; margin-bottom: 6px;
        }
        .lp-problem-text {
          font-size: 14px; line-height: 1.6; color: #7A7570;
        }
        ...
        .lp-feature-desc {
          font-size: 14px; line-height: 1.65; color: #7A7570;
        }
        ...
        .lp-step {
          flex: 1; padding: 32px 24px; border-radius: 18px;
          background: white; border: 1px solid #EDE8E3;
        ...
        .lp-step::before {
          ...
          color: rgba(224,122,95,0.15); position: absolute;
        ...
        .lp-quote {
          ...
          font-style: italic; color: #2C2A28;
          margin-bottom: 16px;
        }
        .lp-attribution {
        ...
        .lp-attr-role {
          font-size: 12px; color: #7A7570; font-weight: 400;
        }
        ...
        .lp-price-period {
          font-size: 15px; color: #7A7570; font-weight: 400;
          font-family: 'DM Sans', sans-serif;
        }
        .lp-price-desc {
          font-size: 13px; color: #7A7570; margin: 8px 0 20px;
        }
        .lp-price-features {
        ...
        .lp-price-features li {
          ...
          font-size: 14px; padding: 6px 0; color: #2C2A28;
        }
        .lp-price-check {
        ...
        .lp-final-cta::before {
          content: ''; position: absolute; inset: 0;
          background:
            radial-gradient(ellipse 600px 400px at 30% 50%, rgba(224,122,95,0.12), transparent),
            radial-gradient(ellipse 400px 400px at 70% 50%, rgba(129,178,154,0.08), transparent);
        }
        .lp-final-title {
          font-family: 'Fraunces', Georgia, serif;
        ...
        .lp-email-input::placeholder { color: rgba(255,255,255,0.4); }
        ...
        .lp-footer-link {
          font-size: 13px; color: #7A7570; cursor: pointer;
        ...
        .lp-mobile-toggle span {
          ...
          background: #2C2A28; border-radius: 2px;
          transition: all 0.2s;
        }
      ...
      <nav className={`lp-nav ${scrolled ? 'scrolled' : ''}`}>
        ...
        <div className="lp-nav-links">
          ...
          <button className="lp-cta-sm" onClick={goApp}>Open App</button>
        </div>
      ...
      {mobileMenu && (
        <div style={{
          position: 'fixed', inset: 0, background: 'rgba(250,248,245,0.98)',
          ...
          <button className="lp-cta-sm" style={{ fontSize: 16, padding: '14px 32px' }} onClick={() => { setMobileMenu(false); goApp() }}>Open App</button>
        </div>
      )}
      ...
      <section className="lp-hero">
        ...
        <FadeIn delay={0.1}>
          <h1 className="lp-h1">
            Your family's <em>care&nbsp;command center</em>
          </h1>
        </FadeIn>

        <FadeIn delay={0.2}>
          <p className="lp-sub">
            One shared place for medications, appointments, tasks, documents,
            and an AI assistant that keeps everyone in the loop.
          </p>
        </FadeIn>

        <FadeIn delay={0.3}>
          <div className="lp-hero-actions">
            <button className="lp-cta-big lp-cta-primary" onClick={goApp}>
              Try the Demo <ArrowRight size={18} />
            </button>
            <button className="lp-cta-big lp-cta-secondary" onClick={() => document.getElementById('features')?.scrollIntoView({ behavior: 'smooth' })}>
              See Features
            </button>
          </div>
        </FadeIn>
          ...
          <div className="lp-social-proof">
            <div className="lp-avatars">
              {['#E07A5F','#81B29A','#5B8FA8','#F2CC8F','#8B7EC8'].map((c, i) => (
                <div key={i} className="lp-avatar-circle" style={{ background: c }}>
                  {['R','D','M','K','S'][i]}
                </div>
              ))}
            </div>
      ...
      {/* ─── How it works ─── */}
      <section className="lp-section" id="how" style={{ background: 'white', maxWidth: 'none', padding: '100px 24px' }}>
          ...
          {TESTIMONIALS.map((t, i) => (
            <FadeIn key={i} delay={i * 0.1}>
              <div className="lp-testimonial">
                ...
                <div className="lp-quote">"{t.text}"</div>
      ...
      {/* ─── Pricing ─── */}
      <section className="lp-section" id="pricing" style={{ background: 'white', maxWidth: 'none', padding: '100px 24px' }}>
        <div style={{ maxWidth: 1100, margin: '0 auto' }}>
          <FadeIn>
            ...
            {PRICING.map((plan, i) => (
              <FadeIn key={i} delay={i * 0.1}>
                <div className={`lp-price-card ${plan.featured ? 'featured' : ''}`}>
                  ...
                  <button
                    className={`lp-price-btn ${plan.featured ? 'primary' : 'outline'}`}
                    onClick={goApp}
                  >
                    {plan.cta}
                  </button>
      ...
      <section className="lp-final-cta">
        <FadeIn>
          <h2 className="lp-final-title">
            Your parents took care of you.<br />Now it's your turn.
          </h2>
        </FadeIn>
        <FadeIn delay={0.1}>
        ...
        <FadeIn delay={0.2}>
          <div className="lp-email-row">
            ...
            />
            <button className="lp-email-btn" onClick={goApp}>
              Get Early Access
            </button>
          </div>
